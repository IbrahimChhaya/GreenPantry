        ...
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           // int currentPage = 2;
            ...
            foreach(ProductCategory p in list)
            {
                ...
                display += "<a href='editcat.aspx?type=Cat&CatID=" + p.ID + "'><span class='name mb-0 text-sm'>" + p.Name + "</span></a></div></div></th>";
                ...
                display += "<a class='dropdown-item' href='editcat.aspx?type=Cat&CatID=" + p.ID + "'>Edit Category</a>";
