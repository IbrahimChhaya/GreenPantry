<%@ Page Language="C#" MasterPageFile="~/dashboard/Dashboard.Master" AutoEventWireup="true" CodeBehind="dashboard.aspx.cs" Inherits="AdminDashboard.dashboard" %>
          ...
          <div class="row">
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                <!-- Card body -->
                <div class="card-body"  id="traffic" runat="server">
                  <div class="row">
                    <div class="col">
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                <!-- Card body -->
                <div class="card-body" id="productSales" runat="server">
                  <div class="row">
                    <div class="col">
